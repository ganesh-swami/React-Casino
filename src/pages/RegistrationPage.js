        ...
        <form onSubmit={onSubmit}>
          <section>
            <div className="flex flex-col items-center mx-auto text-center mt-8">
              <h1 className="text-white content-register">Registration</h1>
            </div>
            <div className="flex flex-col mt-6 items-center md:flex-col">
              <AuthInput refObj={emailRef} type="text">
                E-mail
              </AuthInput>
              <AuthInput refObj={nicknameRef} type="text">
                Nickname
              </AuthInput>
              <AuthInput refObj={passwordRef} type="password">
                Password
              </AuthInput>
              <AuthInput refObj={confirmpasswordRef} type="password">
                Confirm Password
              </AuthInput>
