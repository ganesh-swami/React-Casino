...
const Play = ({ history }) => {
  ...
  // const { entryTableId, amount } = useContext(tableContext);
  ...
  //     if (
  //       currentTable.seats["1"] == null &&
  //       currentTable.seats["2"] == null &&
  //       currentTable.seats["3"] == null &&
  //       currentTable.seats["4"] == null &&
  //       currentTable.seats["5"] == null
  //     ) {
  //       sitDown(entryTableId, 1, amount);
  //     }
  //   }
  // }, [currentTable]);
